...
namespace FixMath.NET
{
  ...
  //      }
        ...
        public static fp Floor(fp value) {
            ...
            return new fp((long)((ulong)value.value & 0xFFFFFFFF00000000));
        }
		...
		public static fp Pow2(fp x)
		{
			...
			if (x == fp._1)
				return neg ? fp._1 / fp._2 : fp._2;
			if (x >= Log2Max) return neg ? fp._1 / fp.max : fp.max;
			if (x <= Log2Min) return neg ? fp.max : fp._0;
		...
		public static fp Acos(fp x)
		{
			...
			fp result = fixmath.Atan(fixmath.Sqrt(fp._1 - x * x) / x);
			if (x.value < 0)
				return result + Pi;
			else
				return result;
  ...
  //      }
		...
		{
			return FromRaw(value.value & 0x00000000FFFFFFFF);
		}
...
//		}
		...
		public static fp SafeMul(fp x, fp y)
		{
			...
			if (topCarry != 0 && topCarry != -1 /*&& xl != -17 && yl != -17*/)
			{
				return opSignsEqual ? fp.max : fp.min;
			}
