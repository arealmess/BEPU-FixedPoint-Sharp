...
namespace BEPUutilities
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        public static void Distance(ref Vector4 a, ref Vector4 b, out fp distance)
        {
            ...
            fp z = a.Z - b.Z;
            fp w = a.W - b.W;
            distance = fixmath.Sqrt(x * x + y * y + z * z + w * w);
        }
        /// <summary>
        /// Computes the distance between two two vectors.
        /// </summary>
        ...
        {
            get { return new Vector4 { X = fp._1 }; }
        }
        ...
        {
            get { return new Vector4 { Y = fp._1 }; }
        }
        ...
        {
            get { return new Vector4 { Z = fp._1 }; }
        }
        ...
        {
            get { return new Vector4 { W = fp._1 }; }
        }
        ...
        {
            fp inverse = fp._1 / fixmath.Sqrt(v.X * v.X + v.Y * v.Y + v.Z * v.Z + v.W * v.W);
            result.X = v.X * inverse;
            result.Y = v.Y * inverse;
            result.Z = v.Z * inverse;
            result.W = v.W * inverse;
