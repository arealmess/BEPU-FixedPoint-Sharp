...
//    /// </summary>
//    public partial struct fp : IEquatable<Fix64>, IComparable<Fix64> {
...
//        public static readonly fp MaxValue = new Fix64(MAX_VALUE);
//        public static readonly fp MinValue = new Fix64(MIN_VALUE);
//		public static readonly fp MinusOne = new Fix64(-ONE);
//		public static readonly fp One = new Fix64(ONE);
//		public static readonly fp Two = (Fix64)2;
//		public static readonly fp Three = (Fix64)3;
//		public static readonly fp Zero = new Fix64();
//		public static readonly fp C0p28 = (Fix64)0.28m;
//		/// <summary>
//		/// The value of Pi
//		/// </summary>
//		public static readonly fp Pi = new Fix64(PI);
//        public static readonly fp PiOver2 = new Fix64(PI_OVER_2);
//		public static readonly fp PiOver4 = new Fix64(PI_OVER_4);
//		public static readonly fp PiTimes2 = new Fix64(PI_TIMES_2);
//        public static readonly fp PiInv = (Fix64)0.3183098861837906715377675267M;
//        public static readonly fp PiOver2Inv = (Fix64)0.6366197723675813430755350535M;
//		public static readonly fp E = new Fix64(E_RAW);
//		public static readonly fp EPow4 = new Fix64(EPOW4);
//		public static readonly fp Ln2 = new Fix64(LN2);
//		public static readonly fp Log2Max = new Fix64(LOG2MAX);
//		public static readonly fp Log2Min = new Fix64(LOG2MIN);

//		static readonly fp LutInterval = (Fix64)(LUT_SIZE - 1) / PiOver2;
...
//		/// Note: Abs(Fix64.MinValue) == fp.max.
//		/// </summary>
...
//			fp result = Fix64.Atan(Fix64.Sqrt(One - x * x) / x);
//			if (x.RawValue < 0)
...
//            return obj is fp && ((Fix64)obj).RawValue == RawValue;
//        }
