...
namespace BEPUphysics.UpdateableSystems
{
    ...
    public class FluidVolume : Updateable, IDuringForcesUpdateable, ICollisionRulesOwner
    {
        ...
        /// Higher values make entities sink more, lower values make entities fp more.
        /// </summary>
        ...
        void GetSamplingOrigin(ref BoundingBox entityBoundingBox, out Vector3 xSpacing, out Vector3 zSpacing, out fp perColumnArea, out Vector3 origin)
        {
			...
			fp samplePointsPerDimensionFP = (fp)samplePointsPerDimension;
			fp widthIncrement = (entityBoundingBox.Max.X - entityBoundingBox.Min.X) / samplePointsPerDimensionFP;
			fp lengthIncrement = (entityBoundingBox.Max.Z - entityBoundingBox.Min.Z) / samplePointsPerDimensionFP;
