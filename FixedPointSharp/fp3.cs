...
namespace Deterministic.FixedPoint
{
  ...
  public struct fp3 : IEquatable<fp3>
  {
    ...
    public static readonly fp3 left = new(-F64.C1, F64.C0, F64.C0);
    public static readonly fp3 right = new(F64.C1, F64.C0, F64.C0);
    public static readonly fp3 up = new(F64.C0, F64.C1, F64.C0);
    public static readonly fp3 down = new(F64.C0, fp.minus_one, F64.C0);
    public static readonly fp3 forward = new(F64.C0, F64.C0, F64.C1);
    public static readonly fp3 backward = new(F64.C0, F64.C0, fp.minus_one);
    public static readonly fp3 one = new(F64.C1, F64.C1, F64.C1);
    public static readonly fp3 minus_one = new(fp.minus_one, fp.minus_one, fp.minus_one);
    public static readonly fp3 zero = new(F64.C0, F64.C0, F64.C0);
    ...
    public static implicit operator fp3(Vector3 vector3)
    {
      return new fp3(vector3.X, vector3.Y, vector3.Z);
    }
